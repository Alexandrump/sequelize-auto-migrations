...
// Función para convertir los tipos de columnas de Sequelize a cadenas de texto
export const reverseSequelizeColType = function (col, prefix = "Sequelize.") {
...
// Función para manejar valores predeterminados de Sequelize
export const reverseSequelizeDefValueType = function (defaultValue, prefix = "Sequelize.") {
...
// Función para analizar índices en los modelos
...
// Función para invertir modelos y generar esquemas
export const reverseModels = function (sequelize, models) {
    ...
    for (let model in models) {
        ...
        for (let column in attributes) {
            ...
            delete attributes[column].values;
        }
...
export const writeMigration = function (revision, migration, migrationsDir, name = "", comment = "") {
    const _commands = `
...
`;
    ...
    const beautifiedCommands = beautify(_commands);
...
export const executeMigration = async (queryInterface, filename, pos = 0, cb) => {
    try {
